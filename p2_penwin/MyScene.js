...
class MyScene extends THREE.Scene {
  ...
  constructor (myCanvas) { 
    ...
    this.model = new Penwin(this.gui, "Controles de Penwin");
  ...
  createGUI () {
    ...
    folder.add(this.guiControls, 'penwinLay')
      .name ('Animación Bonus : ')
      .onChange ( (value) => {
        if(value)
          this.model.bonusAnimOn();
        else
          this.model.bonusAnimOff();});
